...
:: ========================================================
set "PROJECT_NAME=PDF TO CSV PIPELINE"
:: ========================================================
...
:: Verifica se há arquivos PDF na pasta ENTRADA
dir /b "ENTRADA\*.pdf" >nul 2>&1
if %errorlevel% neq 0 (
    color 0E
    echo ERRO: Nenhum arquivo PDF encontrado na pasta ENTRADA.
    echo Coloque os arquivos PDF necessários na pasta ENTRADA e tente novamente.
    echo.
    pause
    exit /b
)
